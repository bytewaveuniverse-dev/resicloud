...
use Livewire\WithPagination; // <--- 1. Importamos la paginación
...
{
    use WithFileUploads, WithPagination; // <--- 2. Habilitamos el trait

    // ... (sus propiedades se mantienen iguales) ...
    ...
    public string $filtroTipo = ''; // Nueva propiedad para el filtro de tipo

    // 3. Este método enviará los datos paginados a la vista automáticamente
    public function with(): array
    {
        ...
        return [
            'asientos' => $query->paginate(10), // Paginamos de 10 en 10
        ];
    }

    // ... (el resto de sus funciones: buscar, seleccionarUsuario, openModal, save, etc., se mantienen IGUAL) ...
...
<div class="p-6">
    ...
    {{-- 4. AGREGAMOS LOS LINKS DE PAGINACIÓN --}}
    <div class="mt-6">
        {{ $asientos->links() }}
    </div>
